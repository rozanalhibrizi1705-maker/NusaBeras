...
export function PublicLanding() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3.5">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight text-foreground">
              Beras<span className="text-primary">Track</span>
            </span>
          </Link>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:py-28">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
              BerasTrack menyajikan data harga beras terkini, prediksi harga
              minggu depan, serta tren pergerakannya per provinsi — transparan
              dan mudah dipahami untuk masyarakat.
            </p>
            <div className="mt-7 flex flex-wrap gap-3">
              <a href="#berastrack" className={buttonVariants({ size: "lg" })}>
      ...
      {/* ---------- Fitur Utama: BerasTrack ---------- */}
      <section id="berastrack" className="mx-auto max-w-6xl px-4 py-14 sm:py-20">
